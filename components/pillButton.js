export default function PillButton({styles = [], className = '', children}){
  ...
  const defaultStyle = 'rounded-full h-max w-max max-w-full px-2 py-px font-["Montserrat"] font-medium transition-colors ';
  const stylePresets = {
    'large': 'text-3xl px-5',
    'med': 'text-2xl px-2',
    'nav': 'bg-brand_purple-600 text-muted_white-100 hover:text-muted_white-100 hover:bg-muted_white-100 hover:text-brand_purple-600',
